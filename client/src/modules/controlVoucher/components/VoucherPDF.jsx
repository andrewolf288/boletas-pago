...
import { VoucherStyles, FontCalibri } from '../styles'
        ...
        <View style={styles.containerFlexRow}>
          ...
          <View style={{ ...styles.containerFlexCol, marginRight: 20 }}>
            ...
            <View style={styles.containerFlexRow}>
              ...
              <Text style={styles.textValuePropertyGrid}>{styleValueProperty(data.esEssalud)}</Text>
            </View>
            {/* SENATI */}
            <View style={styles.containerFlexRow}>
              <Text style={styles.textTitlePropertyGrid}>SENATI</Text>
              <Text style={styles.textValuePropertyGrid}>{styleValueProperty(data.senati)}</Text>
            </View>
            {/* SCTR SALUD Y PENSION */}
            <View style={styles.containerFlexRow}>
              <Text style={styles.textTitlePropertyGrid}>SCTR SALUD Y PENSION</Text>
              <Text style={styles.textValuePropertyGrid}>{styleValueProperty(data.sctrSaludPension)}</Text>
            </View>
          </View>
        </View>
        {/* Linea divisora */}
